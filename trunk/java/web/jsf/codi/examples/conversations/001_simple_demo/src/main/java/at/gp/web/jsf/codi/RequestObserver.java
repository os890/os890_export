...
{
    protected void before(@Observes @AfterPhase(RESTORE_VIEW) FacesContext facesContext)
    {
        System.out.printf("");
    }

    protected void after(@Observes @AfterFacesRequest FacesContext facesContext)
    {
        System.out.printf("");
    }
}
