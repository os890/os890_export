...
import at.gp.web.jsf.extval.validation.strategy.CustomRequiredStrategy;
import at.gp.web.jsf.extval.validation.DefaultValidationErrorMessageResolver;
...
public class ValidationStrategyFactory implements ClassMappingFactory<Annotation, ValidationStrategy>
{
    public ValidationStrategy create(Annotation annotation)
    {
        ...
        {
            resultStrategy = new CustomRequiredStrategy();
            resultStrategy.setMessageResolver(new DefaultValidationErrorMessageResolver());
        }
