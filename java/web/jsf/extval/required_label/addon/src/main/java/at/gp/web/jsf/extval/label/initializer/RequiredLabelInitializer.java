...
/**
 * The Interface RequiredLabelInitializer that can be used to define how a label that is used for a required field should be adjusted for display to
 * reflect the requirement of the field it belongs to.
 * 
