 ...
 */
public class CustomExceptionInterceptor implements ValidationExceptionInterceptor
{
    ...
    public boolean afterThrowing(UIComponent uiComponent, MetaDataEntry metaDataEntry, Object convertedObject, ValidatorException validatorException, ValidationStrategy validatorExceptionSource)
    {
        ...
        {
            logger.trace(validatorExceptionSource.getClass().getName() + " found a constraint violation", validatorException);
        }
        return true;
    }
}
