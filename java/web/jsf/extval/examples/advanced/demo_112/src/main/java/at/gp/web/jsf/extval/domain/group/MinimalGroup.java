 ...
 * under the License.
 */
package at.gp.web.jsf.extval.domain.group;
...
public interface MinimalGroup extends ValidationParameter, Group
{
    @ParameterKey
    Class KEY = Group.class;

    @ParameterValue
    Class VALUE = MinimalGroup.class;
}