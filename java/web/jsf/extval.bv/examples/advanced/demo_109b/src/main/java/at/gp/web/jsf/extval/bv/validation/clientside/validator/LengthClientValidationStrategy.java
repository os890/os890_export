 ...
 */
public class LengthClientValidationStrategy implements ClientValidationStrategy
{
    ...
    public String getClientScript()
    {
        ...
        {
            jsValidation = "return inputField.value && inputField.value.length != 0 && inputField.value.length >= " + this.metaDataValue;
        }
        else if (CommonMetaDataKeys.MAX_LENGTH.equals(this.metaDataKey))
        {
            jsValidation = "if(inputField.value && inputField.value.length != 0) return inputField.value.length <= " + this.metaDataValue + ";"
                    + " else return true";
        }
