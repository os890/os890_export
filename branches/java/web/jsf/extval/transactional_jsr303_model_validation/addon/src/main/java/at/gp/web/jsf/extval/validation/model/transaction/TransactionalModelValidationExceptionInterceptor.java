...
public class TransactionalModelValidationExceptionInterceptor implements ValidationExceptionInterceptor
{
    ...
    {
        ExtValTransactionalModelValidationContext.getCurrentInstance().revertModelChanges();
