...
{
    public abstract Class<? extends ValidationStrategyProvider>[] value();

    /*
     * optional
     */
    public abstract Class<? extends ValidationParameter>[] parameters() default ViolationSeverity.Error.class;
