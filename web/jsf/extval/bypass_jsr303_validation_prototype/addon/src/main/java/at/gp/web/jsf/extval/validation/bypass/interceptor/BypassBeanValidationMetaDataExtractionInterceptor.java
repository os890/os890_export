...
public class BypassBeanValidationMetaDataExtractionInterceptor implements MetaDataExtractionInterceptor
{
    public void afterExtracting(PropertyInformation propertyInformation)
    {
        if (BypassBeanValidationUtils.bypassAllSkipableValidationsForRequest())
        {
